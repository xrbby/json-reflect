...
public class ByteHandler implements TypeHandler {
	...
	public JsonPrimitive serialize(ReflectiveComponent reflectiveComponent, Object value) {
		...
		return new JsonPrimitive(Byte.parseByte(value.toString()));
	}

	@Override
	public Byte deserialize(ReflectiveComponent reflectiveComponent, JsonElement jsonElement) throws HandlerException {

		if(jsonElement.isJsonPrimitive() && jsonElement.getAsJsonPrimitive().isNumber())
			return jsonElement.getAsByte();
		else throw new HandlerException("Invalid JSON element for Byte: " + jsonElement);
	}
}